...
class BusinessInsuranceDB extends StatefulWidget {
  const BusinessInsuranceDB({super.key});

  @override
  State<BusinessInsuranceDB> createState() => _BusinessInsuranceDBState();
}

class _BusinessInsuranceDBState extends State<BusinessInsuranceDB> {
  var companyName,
      insuranceType,
      downloadUrl,
      insuranceNumber,
