...
class HealthInsuraceDB extends StatefulWidget {
  const HealthInsuraceDB({Key? key});

  @override
  State<HealthInsuraceDB> createState() => _HealthInsuraceDBState();
}

class _HealthInsuraceDBState extends State<HealthInsuraceDB> {
  var companyName,
      insuranceType,
      downloadUrl,
      insuranceNumber,
