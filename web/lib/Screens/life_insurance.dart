...
class LifeInsuranceDB extends StatefulWidget {
  const LifeInsuranceDB({super.key});

  @override
  State<LifeInsuranceDB> createState() => _LifeInsuranceDBState();
}

class _LifeInsuranceDBState extends State<LifeInsuranceDB> {
  var companyName,
      insuranceType,
      downloadUrl,
      insuranceNumber,
