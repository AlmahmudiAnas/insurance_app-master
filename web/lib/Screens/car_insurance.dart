...
class CarInsuranceDB extends StatefulWidget {
  const CarInsuranceDB({super.key});

  @override
  State<CarInsuranceDB> createState() => _CarInsuranceDBState();
}

class _CarInsuranceDBState extends State<CarInsuranceDB> {
  var companyName,
      insuranceType,
      downloadUrl,
      insuranceNumber,
