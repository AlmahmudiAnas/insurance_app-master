...
class RejectedClaimSubmissionsDB extends StatefulWidget {
  const RejectedClaimSubmissionsDB({super.key});
  static String routeName = 'Claim Submissions Dashboard';

  @override
  State<RejectedClaimSubmissionsDB> createState() =>
      _RejectedClaimSubmissionsDBState();
}

class _RejectedClaimSubmissionsDBState
    extends State<RejectedClaimSubmissionsDB> {
  var address,
      claimAmount,
      companyName,
      fullName,
