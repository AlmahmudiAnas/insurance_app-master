...
class FloodInsuranceDB extends StatefulWidget {
  const FloodInsuranceDB({super.key});

  @override
  State<FloodInsuranceDB> createState() => _FloodInsuranceDBState();
}

class _FloodInsuranceDBState extends State<FloodInsuranceDB> {
  var companyName,
      insuranceType,
      downloadUrl,
      insuranceNumber,
