...
class IncomeProtectionInsuranceDB extends StatefulWidget {
  const IncomeProtectionInsuranceDB({super.key});

  @override
  State<IncomeProtectionInsuranceDB> createState() =>
      _IncomeProtectionInsuranceDBState();
}

class _IncomeProtectionInsuranceDBState
    extends State<IncomeProtectionInsuranceDB> {
  var companyName,
      insuranceType,
      downloadUrl,
      insuranceNumber,
