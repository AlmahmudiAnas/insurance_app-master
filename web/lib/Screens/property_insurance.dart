...
class PropertyInsuranceDB extends StatefulWidget {
  const PropertyInsuranceDB({super.key});

  @override
  State<PropertyInsuranceDB> createState() => _PropertyInsuranceDBState();
}

class _PropertyInsuranceDBState extends State<PropertyInsuranceDB> {
  var companyName,
      insuranceType,
      downloadUrl,
      insuranceNumber,
